...
int Adafruit_MLX90640::convertHalfFrame(uint16_t *mlx90640Frame, float * framebuf) {
...
/*!
 *    @brief  Read 1 page, calculate temperatures and place into framebuf. Only half the image will update!
